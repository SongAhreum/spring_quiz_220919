...
public class Lesson05Controller {
	...
	//http://localhost/lesson05/quiz02_musicRanking
	@GetMapping("/quiz02_musicRanking")
	public String quiz02(Model model) {
		...
		return"lesson05/quiz02_membership";
	}
	//http://localhost/lesson05/quiz02_membership
	@GetMapping("/quiz02_membership")
	public String quiz022(Model model) {
